...
const Login = () => {
  ...
  const loginMutation = useMutation({
    mutationFn: async (credentials) => {
      ...
      return { success: true }; // Return something to satisfy useMutation's onSuccess
    },
    onSuccess: () => {
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-lg">Exclusive deals & offers</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-white bg-opacity-20 rounded-full p-3">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {loginMutation.isError && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700 mt-1">{loginMutation.error.message}</p>
                </div>
              </div>
            )}
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-semibold py-3 px-4 rounded-lg hover:from-blue-700 hover:to-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
            >
