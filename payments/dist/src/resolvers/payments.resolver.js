...
exports.resolvers = {
    ...
    Mutation: {
        ...
        `;
            ...
            if (isCashfreeEnabled) {
                ...
                try {
                    ...
                    console.error("Error calling Razorpay API:", razorpayError.error ? razorpayError.error : razorpayError.message);
        ...
        handleRazorpayCallback: async (_, { razorpay_order_id, razorpay_payment_id, razorpay_signature, }) => {
            const paymentConfig = await getPaymentConfig();
            const isCashfreeEnabled = paymentConfig.isCashfreeEnabled;
            if (isCashfreeEnabled) {
            ...
            const { data: existingOrder, error: fetchError } = await db_js_1.db
                .from("payment_orders")
                .select("*")
